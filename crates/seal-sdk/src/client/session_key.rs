use crate::client::error::SessionKeyError;
use crate::client::generic_types::{ObjectID, SuiAddress};
use crate::client::signer::Signer;
use crate::types::{ElGamalPublicKey, ElgamalVerificationKey};
use crate::{signed_message, Certificate, ElGamalSecretKey, FetchKeyRequest};
use base64::Engine;
